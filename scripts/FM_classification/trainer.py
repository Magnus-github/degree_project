...
class Trainer:
    def __init__(self, cfg, dataloaders, run_id=None):
        ...
        if "Adam" in cfg.hparams.optimizer.name and cfg.hparams.optimizer.use_scheduler is False:
            ...
            cfg.hparams.scheduler.params.step_per_epoch = len(self.train_dataloader)
            cfg.hparams.scheduler.params.warm_up_steps = 50*cfg.hparams.scheduler.params.step_per_epoch
            cfg.hparams.scheduler.params.num_step_down = 350*cfg.hparams.scheduler.params.step_per_epoch
